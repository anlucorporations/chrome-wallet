...
> **v1.7 (esta versión):** cierra el residual **`R-09`** del veredicto con las decisiones **DEC-45** y **DEC-46**: **dos filas nuevas** en la tabla de errores de §4.3 (una por causa: «Cuenta en uso por una dApp conectada» y «Reset bloqueado»), la **guarda de sesión de dApp activa** en el revelado/exportación y en el borrado de una cuenta importada (§3.10), y la **guarda y el orden de comprobación del reset** con lo que se limpia y lo que se conserva (§3.11). Detalle en §6.5 y §7.
