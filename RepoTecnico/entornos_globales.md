 ...
 **1.8 (esta versión)** — cierre del residual **R-08** del veredicto de reevaluación: el modo de fallo observable de la cuota de `chrome.storage.local` incorpora su evidencia reproducible (`Vitest: storageQuota.spec.ts`).
