...
> **Fuentes (leídas antes de redactar):** `RepoTecnico/casos_uso/casos_uso.md` v1.5 (36 CU — **fuente principal**), `RepoTecnico/requerimientos.md` v1.9 (§1 RF-01..RF-50, §2 RNF-01..RNF-25, §3 RT-01..RT-13 y RE-01..RE-04, §4 rúbrica y MVP, §9 `CA-RF-xx`/`CA-RT-xx`), `RepoTecnico/diccionario_datos.md` v1.8 (claves `truekeate_*`, entidades, protocolo `TRUEKEATE_*`, catálogo RPC y códigos EIP-1193; §4.3 fuente única de los literales de error), `RepoTecnico/entornos_globales.md` v1.9 (permisos —`storage`, `alarms`, `favicon`, `clipboardRead` y `clipboardWrite`—, constantes, comandos, nomenclatura) y `RepoTecnico/casos_uso/AUDITORIA_CASOS_USO_V1.md` (auditoría ya remediada: **no se reintroduce ningún hallazgo ACU-01..ACU-30**).
>
...
|---|---|---|
| 1.0 | — | Emisión inicial con los 12 diagramas exigidos: casos de uso (36 CU y 8 actores), 8 secuencias de flujos críticos, estados del ciclo de aprobación, arquitectura de componentes, índice de trazabilidad e instrucciones de renderizado. Sin modificar ningún otro archivo y sin instalar paquetes. |
| 1.1 | — | Alineación de las referencias de CU y de las fuentes citadas con el corpus remediado de la Fase 2 (ADT-01..ADT-33); sin cambios en el número de figuras. |
| **1.2** | Sesión de cierre de los residuales `VR-01..VR-10` | Bloque **«Fuentes»** sincronizado con las versiones vigentes del corpus (`casos_uso.md` **v1.5**, `requerimientos.md` **v1.9**, `diccionario_datos.md` **v1.8** y `entornos_globales.md` **v1.9**), con los permisos del manifest citados; se repara el marcador corrupto del historial (`ANCHOR_DIAGRAMAS`). Sin cambios en los 12 diagramas. |
