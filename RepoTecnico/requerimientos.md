...
```
**Evidencia:** `E2E: 04-enviar.spec.ts` · `Vitest: rpc/txContract.spec.ts` (incluye `estimateGas` fallido y revert de RNF-25).
...
```
**Evidencia:** `Vitest: approvals/queue.spec.ts` · `E2E: 18-concurrencia.spec.ts`. **Cierra H-02 y H-08.**
