...
| Funcionalidad (40) | `eth_signTypedData_v4` firma mensajes EIP-712 (7) | RF-20, RT-11, RNF-25 | `E2E: 11-firmar-eip712.spec.ts` · `Comando: forge test --match-contract EIP712VerifierTest` |
...
```
**Evidencia:** `E2E: 11-firmar-eip712.spec.ts` · `Vitest: typedData.spec.ts` · `Comando: forge test --match-contract EIP712VerifierTest`. **Cierra H-11b (EIP-712) y H-40.**
